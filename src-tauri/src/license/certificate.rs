...
// Dev keypair — pair with the dev ED25519_PRIVATE_KEY on dimkey-site server.
// Generated by `go run ./cmd/dimkey-keygen` in the dimkey-site repo.
// Rotate (regenerate both halves, redeploy client + server) before prod cut-over.
pub const PUBKEY_V1: [u8; 32] = [
    0xf4, 0x22, 0x11, 0x54, 0xb7, 0x2b, 0x19, 0x7c,
    0x0d, 0x6f, 0xd6, 0xba, 0x32, 0x40, 0xee, 0xac,
    0x9e, 0xc4, 0x38, 0x17, 0xee, 0x5c, 0x4a, 0xbc,
    0x98, 0xa2, 0xf1, 0x03, 0x52, 0xaf, 0x53, 0xa8,
];
